...
pub fn decode_message(message: [u8; 32]) -> MessageType {
    match message[0] {
        ...
        1 => MessageType::Move(match message[1] {
...
pub fn encode_message(message: MessageType) -> Vec<u8> {
    ...
    match message {
        ...
        MessageType::Move(mv) => match mv {
            ...
            Move::Promotion(pos1, pos2, piece_type) => {
                encoded_message.extend_from_slice(&[1, 2, pos1, pos2, piece_type])
            }
